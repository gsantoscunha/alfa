...
# Carregar planilha direto do GitHub
@st.cache_data
def carregar_dados():
    url = "https://raw.githubusercontent.com/gsantoscunha/alfa/main/extrato%20raw.xlsx"
    df = pd.read_excel(url, sheet_name="Extrato")
